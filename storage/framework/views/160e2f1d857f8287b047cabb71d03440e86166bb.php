...
<body>
    ...
    <div class="container">
        ...
        <form action="<?php echo url('/Task/Update'); ?>" method="post" enctype="multipart/form-data">
...
<?php /**PATH H:\xamp\htdocs\simpletask\resources\views/Task/edit.blade.php ENDPATH**/ ?>